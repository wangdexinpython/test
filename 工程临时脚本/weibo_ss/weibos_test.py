...
class Weibo(object):
    def __init__(self,*args,**kwargs):
        self.url=args[0]
        self.username = "13439303439"
        password =  "cjp106387".encode('utf8')
        ...
        self.user_name = "zhaoqiang_zq@126.com"
        self.pass_word = "1!aA123"
        self.headers = {
    ...
    def get_url(self,url):
        ...
        response = session.get(url=url_api,proxies=proxies)
        print(response.text)
